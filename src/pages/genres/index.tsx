...
const Genres = () => {
      ...
      render: (_: any, record: ICategory) => (
        <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
          <Button
            ...
            onClick={() =>
              customNavigate(
                route(routes.GENRES_EDIT, { id: record.id as string }),
                search
              )
            }
            label={t("edit")}
          ...
          <Button
            ...
            onClick={() =>
              customNavigate(
                route(routes.GENRES_SHOW, { id: record.id as string }),
                search
              )
            }
            label={t("read")}
  ...
  const request = useMemo(() => {
    return {
      ...
      queryFn: (params: any) => API.getGenres({ ...params, ig: false }),
    };
  }, []);
  ...
  return (
    <Table
      ...
      rowKey="id"
      request={request}
      createUrl={routes.GENRES_CREATE}

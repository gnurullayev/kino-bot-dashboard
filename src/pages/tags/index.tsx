...
const Tags = () => {
      ...
      render: (_: any, record: ICategory) => (
        <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
          <Button
            ...
            onClick={() =>
              customNavigate(
                route(routes.TAGS_EDIT, { id: record.id as string }),
                search
              )
            }
            label={t("edit")}
          ...
          <Button
            ...
            onClick={() =>
              customNavigate(
                route(routes.TAGS_SHOW, { id: record.id as string }),
                search
              )
            }
            label={t("read")}
  ...
  const request = useMemo(() => {
    return {
      ...
      queryFn: (params: any) => API.getTags({ ...params, ig: false }),
    };
  }, []);
